          ...
          return FutureBuilder<List<Map<String, dynamic>>>(
            ...
            builder: (context, gallerySnapshot) {
              ...
              if (gallerySnapshot.hasData) {
                images = gallerySnapshot.data!.map((img) => img['image_url'] as String).toList();
              }
              
              // Añadir cover_url como primera imagen si existe
              if (business['cover_url'] != null) {
                images.insert(0, business['cover_url'] as String);
              }
